...
/*******************************************************/
    ...
    $(document).on("click", '#settings1', function (event){
...
/********************** Functions*********************************/
    ...
    function createAddress(){
        ...
        if(hash.length > 0 ){
            var bytes  = CryptoJS.AES.decrypt(hash.toString(), password);
            var dencrypted = bytes.toString(CryptoJS.enc.Utf8);
            console.log("AES dencrypted: " + dencrypted);
            code = new Mnemonic(dencrypted);
            ...
            **/
            ...
            if(password.length > 0 ){
                ...
                // Codes for Password
                var ciphertext = CryptoJS.AES.encrypt(code.toString(), password);
